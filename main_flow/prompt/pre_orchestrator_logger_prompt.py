"""
PreOrchestratorLogger Prompt Template

This prompt is used to summarize the flow state before orchestration begins.
It captures what agents were identified and what the user's intent is.
"""

from pydantic import BaseModel, Field

class PreOrchestratorLoggerOutput(BaseModel):
    """Structured output for the pre-orchestrator logger"""
    summary: str = Field(
        description="Concise summary of the flow state before orchestration"
    )
