...
class FinanceAgentState(BaseModel):
    """
    FinanceAgentState: Memory and state management for the Finance sub-agent.

    This state tracks the finance agent's workflow including quotation generation,
    invoice processing, job creation, and other finance-related operations.
    """
