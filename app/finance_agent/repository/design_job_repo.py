"""
Design Job Repository for CRUD operations on Finance.design_job table.
...
# All columns in the design_job table
...
class DesignJobRepo(BaseRepository):
    """
    ...
    def __init__(self):
        """Initialize repository with design_job table."""
        super().__init__(
            table=DBTable_Enum.DESIGN_JOB_TABLE,
    ...
    def find_by_job_no(self, job_no: str) -> Optional[JobRow]:
        ...
        Example:
            >>> repo.find_by_job_no('JCP-25-01-1')
        """
