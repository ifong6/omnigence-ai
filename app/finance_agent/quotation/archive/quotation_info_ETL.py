...
def quotation_info_ETL_node(state: FinanceAgentState):
    ...
    try:
        ...
        parsed_response_extract = invoke_openai_llm(system_prompt_extract, QuotationInfoExtractOutput)
        ...
        for idx, single_quotation in enumerate(extracted_quotation_info, 1):
            ...
            parsed_response_transform = invoke_gemini_llm_streaming(system_prompt_transform)
