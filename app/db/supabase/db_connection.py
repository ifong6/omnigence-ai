...
if __name__ == "__main__":
    # The schema is "Finance" with capital F (created with quotes)
    # Must use quoted identifiers to preserve case in PostgreSQL
    data = execute_query('SELECT * FROM "Finance".company', fetch=True)
    print("\n=== Company Data ===")
    print(data)